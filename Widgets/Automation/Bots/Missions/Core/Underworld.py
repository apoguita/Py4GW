...
def _draw_help():
    ...
    PyImGui.bullet_text(r'You should change the line 39 in Sources\oazix\CustomBehaviors\skills\botting\wait_if_party_member_too_far.py with * 1.25 for faster runs')
    PyImGui.separator()
