...
class ParagonRefrain_UtilitySkillBar(CustomBehaviorBaseUtility):
    ...
    def __init__(self):
        ...
        self.heroic_refrain_utility: CustomSkillUtilityBase = HeroicRefrainUtility(
            current_build=in_game_build, score_definition=ScoreStaticDefinition(50)
        )
        self.theyre_on_fire_utility: CustomSkillUtilityBase = KeepSelfEffectUpUtility(
            skill=CustomSkill("Theyre_on_Fire"),
        ...
        self.save_yourselves_luxon: CustomSkillUtilityBase = ProtectiveShoutUtility(
        ...
        self.never_surrender: CustomSkillUtilityBase = ProtectiveShoutUtility(
            skill=CustomSkill("Never_Surrender"),
            current_build=in_game_build,
            allies_health_less_than_percent=0.7,
