...
class RangerTaoVolleyUtilitySkillBar(CustomBehaviorBaseUtility):
    ...
    def __init__(self):
        ...
        self.savage_shot_utility: CustomSkillUtilityBase = SavageShotUtility(
            current_build=in_game_build, score_definition=ScoreStaticDefinition(91)
        )
        self.distracting_shot_utility: CustomSkillUtilityBase = DistractingShotUtility(
        ...
        # optional
        self.never_rampage_alone_utility: CustomSkillUtilityBase = KeepSelfEffectUpUtility(
        ...
        self.triple_shot_utility: CustomSkillUtilityBase = RawSimpleAttackUtility(
            skill=CustomSkill("Triple_Shot_luxon"),
            current_build=in_game_build,
            mana_required_to_cast=10,
            score_definition=ScoreStaticDefinition(70),
        )
        self.sundering_attack_utility: CustomSkillUtilityBase = RawSimpleAttackUtility(
            skill=CustomSkill("Sundering_Attack"),
            current_build=in_game_build,
            mana_required_to_cast=10,
