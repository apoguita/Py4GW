...
FSM_vars.state_machine_warrior.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805001", 16)), transition_delay_ms=300, run_once=True)
...
FSM_vars.state_machine_warrior.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_warrior.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805007", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_warrior.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80DD01", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_warrior.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_warrior.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80DD07", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_warrior.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805501", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_warrior.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_warrior.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805507", 16)), transition_delay_ms=1500, run_once=True)
#END WARRIOR ROUTINE
...
FSM_vars.state_machine_warrior.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_warrior.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804703", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_warrior.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x804701", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_warrior.AddState(name="USING IMP STONE", execute_fn=lambda: useitem(30847), run_once=True)
...
FSM_vars.state_machine_warrior.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_warrior.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802E01", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_ranger.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805001", 16)), transition_delay_ms=300, run_once=True)
...
FSM_vars.state_machine_ranger.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_ranger.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805007", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80DE01", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_ranger.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_ranger.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80DE07", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805601", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_ranger.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_ranger.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805607", 16)), transition_delay_ms=1500, run_once=True)
#END RANGER ROUTINE
#START COMMON ROUTINE PART TWO
...
FSM_vars.state_machine_ranger.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_ranger.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804703", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x804701", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger.AddState(name="USING IMP STONE", execute_fn=lambda: useitem(30847), run_once=True)
...
FSM_vars.state_machine_ranger.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_ranger.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802E01", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_monk.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805001", 16)), transition_delay_ms=300, run_once=True)
...
FSM_vars.state_machine_monk.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_monk.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805007", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80DC01", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_monk.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_monk.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80DC07", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805401", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_monk.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_monk.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805407", 16)), transition_delay_ms=1500, run_once=True)
#END MONK ROUTINE
#START COMMON ROUTINE PART TWO
...
FSM_vars.state_machine_monk.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_monk.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804703", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x804701", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_monk.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_monk.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802E01", 16)), transition_delay_ms=1500, run_once=True)
#END COMMON ROUTINE PART TWO
...
FSM_vars.state_machine_necromancer.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805001", 16)), transition_delay_ms=300, run_once=True)
...
FSM_vars.state_machine_necromancer.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_necromancer.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805007", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necromancer.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80DA01", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_necromancer.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_necromancer.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80DA07", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necromancer.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805201", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_necromancer.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_necromancer.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805207", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_necromancer.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_necromancer.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804703", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necromancer.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x804701", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necromancer.AddState(name="USING IMP STONE", execute_fn=lambda: useitem(30847), run_once=True)
...
FSM_vars.state_machine_necromancer.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_necromancer.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802E01", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_mesmer.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805001", 16)), transition_delay_ms=300, run_once=True)
...
FSM_vars.state_machine_mesmer.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_mesmer.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805007", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_mesmer.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80D901", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_mesmer.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_mesmer.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80D907", 16)), transition_delay_ms=300, run_once=True)
FSM_vars.state_machine_mesmer.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805101", 16)), transition_delay_ms=300, run_once=True)
...
FSM_vars.state_machine_mesmer.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_mesmer.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805107", 16)), transition_delay_ms=300, run_once=True)
#END MESMER ROUTINE
#START COMMON ROUTINE PART TWO
...
FSM_vars.state_machine_mesmer.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_mesmer.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804703", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_mesmer.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x804701", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_mesmer.AddState(name="USING IMP STONE", execute_fn=lambda: useitem(30847), run_once=True)
...
FSM_vars.state_machine_mesmer.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_mesmer.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802E01", 16)), transition_delay_ms=1500, run_once=True)
#END COMMON ROUTINE PART TWO
...
FSM_vars.state_machine_elementalist.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805001", 16)), transition_delay_ms=300, run_once=True)
...
FSM_vars.state_machine_elementalist.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_elementalist.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x805007", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_elementalist.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80DB01", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_elementalist.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_elementalist.AddState(name="TAKING REWARD", execute_fn=lambda: Player.SendAgentDialog(int("0x80DB07", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_elementalist.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805301", 16)), transition_delay_ms=300, run_once=True)
...
FSM_vars.state_machine_elementalist.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_elementalist.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805307", 16)), transition_delay_ms=300, run_once=True)
...
FSM_vars.state_machine_elementalist.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_elementalist.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804703", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_elementalist.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x804701", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_elementalist.AddState(name="USING IMP STONE", execute_fn=lambda: useitem(30847), run_once=True)
...
FSM_vars.state_machine_elementalist.AddState(name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=2000, run_once=True)
FSM_vars.state_machine_elementalist.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802E01", 16)), transition_delay_ms=1500, run_once=True)
#END COMMON ROUTINE PART TWO
...
FSM_vars.state_machine_ResetQuest.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802E01", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_TamePet.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804C03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_TamePet.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x804C01", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_TamePet.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x85", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_warrior_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804B03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_warrior_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804B01", 16)), transition_delay_ms=3000, run_once=True)
...
FSM_vars.state_machine_warrior_req.AddState(name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=1000, run_once=True)
FSM_vars.state_machine_warrior_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x803C03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_warrior_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x803C01", 16)), transition_delay_ms=3000, run_once=True)
FSM_vars.state_machine_warrior_req.AddState(name="WALKING TO QUEST", execute_fn=lambda: Routines.Movement.FollowPath(FSM_vars.warrior_skill_pathing_2, FSM_vars.movement_handler), exit_condition=lambda: Routines.Movement.IsFollowPathFinished(FSM_vars.warrior_skill_pathing_2, FSM_vars.movement_handler), run_once=False)
FSM_vars.state_machine_warrior_req.AddState(name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=1000, run_once=True)
FSM_vars.state_machine_warrior_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802803", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_warrior_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802801", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_warrior_noreq.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804B03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_warrior_noreq.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804B01", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_warrior_noreq.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x85", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_warrior_noreq.AddState(name="GOING BACK TO ASCALON", execute_fn=lambda: LDoA_TravelToOutpost(bot_vars.ascalon_map), exit_condition=lambda: Map.IsMapReady() and LDoA_IsOutpost() and Party.IsPartyLoaded(), transition_delay_ms=5000, run_once=True)
...
FSM_vars.state_machine_ranger_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804C03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger_req.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x804C01", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger_req.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x85", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_ranger_req.AddState(name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=1000, run_once=True)
FSM_vars.state_machine_ranger_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802A03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802A01", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_ranger_req.AddState(name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=1000, run_once=True)
FSM_vars.state_machine_ranger_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805803", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805801", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger_req.AddState(name="GOING BACK TO ASCALON", execute_fn=lambda: LDoA_TravelToOutpost(bot_vars.ascalon_map), exit_condition=lambda: Map.IsMapReady() and LDoA_IsOutpost() and Party.IsPartyLoaded(), transition_delay_ms=5000, run_once=True)
...
FSM_vars.state_machine_ranger_noreq.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804C03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger_noreq.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x804C01", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger_noreq.AddState(name="TAKING SKILLS", execute_fn=lambda: Player.SendAgentDialog(int("0x85", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_ranger_noreq.AddState(name="WALKING TO REGENT VALLEY", execute_fn=lambda: Routines.Movement.FollowPath(FSM_vars.tamepet_pathing_3, FSM_vars.movement_handler), exit_condition=lambda: Routines.Movement.IsFollowPathFinished(FSM_vars.tamepet_pathing_3, FSM_vars.movement_handler), run_once=False)
...
FSM_vars.state_machine_monk_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805703", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x805701", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_monk_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=1000, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804A03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804A01", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="GOING BACK TO ASCALON", execute_fn=lambda: LDoA_TravelToOutpost(bot_vars.ascalon_map), exit_condition=lambda: Map.IsMapReady() and LDoA_IsOutpost() and Party.IsPartyLoaded(), transition_delay_ms=5000, run_once=True)
...
FSM_vars.state_machine_monk_req.AddState(name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=1000, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804D03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804D01", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_req.AddState(name="GOING BACK TO ASCALON", execute_fn=lambda: LDoA_TravelToOutpost(bot_vars.ascalon_map), exit_condition=lambda: Map.IsMapReady() and LDoA_IsOutpost() and Party.IsPartyLoaded(), transition_delay_ms=5000, run_once=True)
...
FSM_vars.state_machine_monk_noreq.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804A03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_noreq.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804A01", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_monk_noreq.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x85", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_necro_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804803", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804801", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_necro_req.AddState(name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=1000, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802F03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802F01", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="GOING BACK TO ASCALON", execute_fn=lambda: LDoA_TravelToOutpost(bot_vars.ascalon_map), exit_condition=lambda: Map.IsMapReady() and LDoA_IsOutpost() and Party.IsPartyLoaded(), transition_delay_ms=5000, run_once=True)
...
FSM_vars.state_machine_necro_req.AddState(name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=1000, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802B03", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x802B01", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="PRESS ESC", execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_req.AddState(name="GOING BACK TO ASCALON", execute_fn=lambda: LDoA_TravelToOutpost(bot_vars.ascalon_map), exit_condition=lambda: Map.IsMapReady() and LDoA_IsOutpost() and Party.IsPartyLoaded(), transition_delay_ms=5000, run_once=True)
...
FSM_vars.state_machine_necro_noreq.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804803", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_noreq.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x804801", 16)), transition_delay_ms=1500, run_once=True)
FSM_vars.state_machine_necro_noreq.AddState(name="TAKING QUEST", execute_fn=lambda: Player.SendAgentDialog(int("0x85", 16)), transition_delay_ms=1500, run_once=True)
...
FSM_vars.state_machine_nicholas_sandford.AddState(name="TAKING QUEST",
                       execute_fn=lambda: (Py4GW.Console.Log("TH3KUM1KO -  GOING TO NICHOLAS SANDFORD", "TAKING GIFTS FROM NICHOLAS SANDFORD", Py4GW.Console.MessageType.Info),Player.SendAgentDialog(int("0x85", 16))),
                       transition_delay_ms=100,
                       run_once=True)

FSM_vars.state_machine_nicholas_sandford.AddState(name="TAKING QUEST",
                       execute_fn=lambda: (Py4GW.Console.Log("TH3KUM1KO -  GOING TO NICHOLAS SANDFORD", "TAKING GIFTS FROM NICHOLAS SANDFORD", Py4GW.Console.MessageType.Info),Player.SendAgentDialog(int("0x86", 16))),
                       transition_delay_ms=100,
                       run_once=True)
