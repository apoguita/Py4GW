    ...
    try:
        ...
        if len(filtered_agent_ids) > 0:
            ...
            if (
                ...
                Py4GW.Console.Log(
                    "Baked Husk Loot", "Loot target timeout - giving up", Py4GW.Console.MessageType.Warning
                )
                FSM_vars.current_loot_target = None
    ...
    try:
        ...
        if FSM_vars.last_position == current_pos:
            if FSM_vars.position_stuck_time == 0.0:
                ...
                Py4GW.Console.Log(
                    "Movement", "Bot appears stuck - resetting movement", Py4GW.Console.MessageType.Warning
                )
                FSM_vars.movement_handler.reset()
                FSM_vars.current_loot_target = None
...
FSM_vars.state_machine_dull_carapaces.AddState(
    ...
    execute_fn=lambda: (
        (
            Py4GW.Console.Log(
                "TH3KUM1KO - DULL CARAPACES FARM", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info
            ),
...
FSM_vars.state_machine_dull_carapaces.AddState(
    ...
    exit_condition=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO - DULL CARAPACES FARM", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info
        ),
        Map.IsExplorable(),
    ),
    transition_delay_ms=3000,
...
FSM_vars.state_machine_dull_carapaces.AddState(
    ...
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - DULL CARAPACES FARM", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=False,
)
...
FSM_vars.state_machine_dull_carapaces.AddState(
    name="COUNTER",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - DULL CARAPACES FARM", "ADD COUNTER", Py4GW.Console.MessageType.Info),
...
FSM_vars.state_machine_gargoyle_skulls.AddState(
    ...
    execute_fn=lambda: (
        (
            Py4GW.Console.Log(
                "TH3KUM1KO - GARGOYLE SKULLS FARM", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info
            ),
...
FSM_vars.state_machine_gargoyle_skulls.AddState(
    ...
    exit_condition=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO - GARGOYLE SKULLS FARM", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info
        ),
        Map.IsExplorable(),
    ),
    transition_delay_ms=5000,
...
FSM_vars.state_machine_gargoyle_skulls.AddState(
    name="HEY THERE IS A FIRE ALLY",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - GARGOYLE SKULLS FARM", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=False,
)
...
FSM_vars.state_machine_gargoyle_skulls.AddState(
    name="COUNTER",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - LDoA LVL 2-10", "ADD COUNTER", Py4GW.Console.MessageType.Info),
        increment_run_counter(),
    ),
    transition_delay_ms=1000,
    run_once=True,
...
FSM_vars.state_machine_grawl_necklaces.AddState(
    ...
    execute_fn=lambda: (
        (
            Py4GW.Console.Log(
                "TH3KUM1KO - GRAWL NECKLACES FARM", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info
            ),
            LDoA_TravelToDistrict(bot_vars.barradin_map, 6, 0),
        )
        if not Map.IsExplorable()
...
FSM_vars.state_machine_grawl_necklaces.AddState(
    ...
    exit_condition=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO - GRAWL NECKLACES FARM", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info
        ),
        Map.IsExplorable(),
    ),
    transition_delay_ms=3000,
...
FSM_vars.state_machine_grawl_necklaces.AddState(
    name="HEY THERE IS A FIRE ALLY",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - GRAWL NECKLACES FARM", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=False,
)
...
FSM_vars.state_machine_grawl_necklaces.AddState(
    name="COUNTER",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - GRAWL NECKLACES FARM", "ADD COUNTER", Py4GW.Console.MessageType.Info),
        increment_run_counter(),
    ),
...
FSM_vars.state_machine_icy_lodestones.AddState(
    name="COUNTER",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - ICY LODESTONES FARM", "ADD COUNTER", Py4GW.Console.MessageType.Info),
        increment_run_counter(),
    ),
    exit_condition=lambda: Map.IsExplorable(),
    transition_delay_ms=1000,
...
FSM_vars.state_machine_lodestone.AddState(
    ...
    execute_fn=lambda: (
        (
            Py4GW.Console.Log(
                "TH3KUM1KO - ENCHANTED LODESTONE FARM", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info
            ),
            LDoA_TravelToDistrict(bot_vars.barradin_map, 6, 0),
        )
        if not Map.IsExplorable()
...
FSM_vars.state_machine_lodestone.AddState(
    ...
    exit_condition=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO - ENCHANTED LODESTONE FARM", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info
        ),
        Map.IsExplorable(),
    ),
    transition_delay_ms=3000,
...
FSM_vars.state_machine_lodestone.AddState(
    name="HEY THERE IS A FIRE ALLY",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - ENCHANTED LODESTONE FARM", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=False,
)
...
FSM_vars.state_machine_red_iris_flowers.AddState(
    ...
    execute_fn=lambda: (
        (
            Py4GW.Console.Log(
                "TH3KUM1KO - RED IRIS FLOWERS FARM", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info
            ),
            LDoA_TravelToDistrict(bot_vars.ascalon_map, 6, 0),
        )
        if not Map.IsExplorable()
...
FSM_vars.state_machine_red_iris_flowers.AddState(
    ...
    execute_fn=lambda: (
        (
            Py4GW.Console.Log(
                "TH3KUM1KO - RED IRIS FLOWERS FARM", "RUNNING OUT OF TOWN", Py4GW.Console.MessageType.Info
            ),
...
FSM_vars.state_machine_red_iris_flowers.AddState(
    ...
    exit_condition=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO - RED IRIS FLOWERS FARM", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info
        ),
        Map.IsExplorable(),
    ),
...
FSM_vars.state_machine_red_iris_flowers.AddState(
    name="HEY THERE IS A FIRE ALLY",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - RED IRIS FLOWERS FARM", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=False,
)
...
FSM_vars.state_machine_red_iris_flowers.AddState(
    name="COUNTER",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - RED IRIS FLOWERS FARM", "ADD COUNTER", Py4GW.Console.MessageType.Info),
        increment_run_counter(),
    ),
    exit_condition=lambda: Map.IsExplorable(),
    transition_delay_ms=1000,
...
FSM_vars.state_machine_skele_limbs.AddState(
    name="BARRADIN",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - SKELETAL LIMBS", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info),
        LDoA_TravelToDistrict(bot_vars.barradin_map, 6, 0),
    ),
    exit_condition=lambda: LDoA_IsOutpost(),
    transition_delay_ms=1000,
...
FSM_vars.state_machine_skele_limbs.AddState(
    name="WAITING YOUR SLOW PC TO LOAD",
    exit_condition=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - SKELETAL LIMBS", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info),
        Map.IsExplorable(),
    ),
    transition_delay_ms=1000,
)
...
FSM_vars.state_machine_skele_limbs.AddState(
    name="HEY THERE IS A FIRE ALLY",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - SKELETAL LIMBS", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=False,
)
...
FSM_vars.state_machine_skale_fin.AddState(
    name="BARRADIN",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - SKALE FIN FARM", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info),
...
FSM_vars.state_machine_skale_fin.AddState(
    name="WAITING YOUR SLOW PC TO LOAD",
    exit_condition=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - SKALE FIN FARM", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info),
        Map.IsExplorable(),
    ),
    transition_delay_ms=5000,
)
...
FSM_vars.state_machine_skale_fin.AddState(
    name="HEY THERE IS A FIRE ALLY",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - SKALE FIN FARM", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=False,
)
...
FSM_vars.state_machine_skale_fin.AddState(
    name="COUNTER",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO  WORN BELTS", "ADD COUNTER", Py4GW.Console.MessageType.Info),
        increment_run_counter(),
    ),
    exit_condition=lambda: Map.IsExplorable(),
    transition_delay_ms=1000,
...
FSM_vars.state_machine_spider_leg.AddState(
    name="FORT RANIK",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - SPIDER LEGS FARM", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info),
        LDoA_TravelToDistrict(bot_vars.ranik_map, 6, 0),
    ),
    exit_condition=lambda: LDoA_IsOutpost(),
    transition_delay_ms=1000,
...
FSM_vars.state_machine_spider_leg.AddState(
    name="WAITING YOUR SLOW PC TO LOAD",
    exit_condition=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - SPIDER LEGS FARM", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info),
        Map.IsExplorable(),
    ),
    transition_delay_ms=1000,
)
...
FSM_vars.state_machine_spider_leg.AddState(
    name="HEY THERE IS A FIRE ALLY",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - SPIDER LEGS FARM", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=False,
)
...
FSM_vars.state_machine_spider_leg.AddState(
    name="MESSAGE",
    execute_fn=lambda: Py4GW.Console.Log(
        "TH3KUM1KO - SPIDER LEGS FARM", "HUNTING SPIDERS", Py4GW.Console.MessageType.Info
    ),
    exit_condition=lambda: Map.IsExplorable(),
    transition_delay_ms=100,
    run_once=True,
...
FSM_vars.state_machine_spider_leg.AddState(
    ...
    execute_fn=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO - SPIDER LEGS FARM", "INTERACTING WITH BASKET OF APPLES", Py4GW.Console.MessageType.Info
        ),
...
FSM_vars.state_machine_spider_leg.AddState(
    ...
    execute_fn=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO - SPIDER LEGS FARM", "DROPPING THE BASKET OF APPLES", Py4GW.Console.MessageType.Info
        ),
...
FSM_vars.state_machine_unnatural_seeds.AddState(
    ...
    execute_fn=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO - UNNATURAL SEEDS FARM", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info
        ),
        LDoA_TravelToDistrict(bot_vars.barradin_map, 6, 0),
    ),
    exit_condition=lambda: LDoA_IsOutpost(),
...
FSM_vars.state_machine_unnatural_seeds.AddState(
    ...
    exit_condition=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO -  UNNATURAL SEEDS FARM", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info
        ),
        Map.IsExplorable(),
    ),
    transition_delay_ms=3000,
...
FSM_vars.state_machine_unnatural_seeds.AddState(
    name="HEY THERE IS A FIRE ALLY",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO -  UNNATURAL SEEDS FARM", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=True,
)
...
FSM_vars.state_machine_worn_belts.AddState(
    name="BARRADIN",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO - WORN BELTS", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info),
        LDoA_TravelToDistrict(bot_vars.barradin_map, 6, 0),
    ),
    exit_condition=lambda: LDoA_IsOutpost(),
    transition_delay_ms=1000,
...
FSM_vars.state_machine_worn_belts.AddState(
    ...
    exit_condition=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO -  TH3KUM1KO - WORN BELTS", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info
        ),
        Map.IsExplorable(),
    ),
    transition_delay_ms=3000,
...
FSM_vars.state_machine_worn_belts.AddState(
    name="HEY THERE IS A FIRE ALLY",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO -  TH3KUM1KO - WORN BELTS", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=True,
)
...
FSM_vars.state_machine_baked_husks.AddState(
    ...
    execute_fn=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO -  GOING TO BAKED HUSKS", "MOVING TO ASHFORD ABBEY", Py4GW.Console.MessageType.Info
        ),
        Py4GW.Console.Log("BAKED HUSKS", "Executing travel function", Py4GW.Console.MessageType.Info),
        Py4GW.Console.Log("BAKED HUSKS", f"Traveling to map ID: {bot_vars.abbey_map}", Py4GW.Console.MessageType.Info),
...
FSM_vars.state_machine_baked_husks.AddState(
    ...
    exit_condition=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO -  GOING TO BAKED HUSKS", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info
        ),
        Map.IsExplorable(),
    ),
    transition_delay_ms=3000,
...
FSM_vars.state_machine_baked_husks.AddState(
    name="HEY THERE IS A FIRE ALLY",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO -  GOING TO BAKED HUSKS", "USING FIRE STONE", Py4GW.Console.MessageType.Info),
        useitem(30847),
    ),
    run_once=True,
)
...
FSM_vars.state_machine_baked_husks.AddState(
    name="COUNTER",
    execute_fn=lambda: (
        Py4GW.Console.Log("TH3KUM1KO  BAKED HUSKS", "ADD COUNTER", Py4GW.Console.MessageType.Info),
        increment_run_counter(),
    ),
    exit_condition=lambda: Map.IsExplorable(),
    transition_delay_ms=1000,
...
FSM_vars.state_machine_charr_gate_opener.AddState(
    ...
    execute_fn=lambda: (
        (
            Py4GW.Console.Log(
                "TH3KUM1KO - CHARR GATE OPENER", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info
            ),
            LDoA_TravelToDistrict(bot_vars.ascalon_map, 6, 0),
        )
        if not Map.IsExplorable()
...
FSM_vars.state_machine_charr_gate_opener.AddState(
    ...
    exit_condition=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO - CHARR GATE OPENER", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info
        ),
        Map.IsExplorable(),
    ),
    transition_delay_ms=3000,
...
FSM_vars.state_machine_nicholas_sandford.AddState(
    ...
    execute_fn=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO -  GOING TO NICHOLAS SANDFORD", "MOVING TO A SAFER DISTRICT", Py4GW.Console.MessageType.Info
        ),
        LDoA_TravelToDistrict(bot_vars.ranik_map, 6, 0),
    ),
    exit_condition=lambda: LDoA_IsOutpost(),
...
FSM_vars.state_machine_nicholas_sandford.AddState(
    ...
    exit_condition=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO -  GOING TO NICHOLAS SANDFORD", "WAITING FOR EXPLORABLE MAP", Py4GW.Console.MessageType.Info
        ),
        Map.IsExplorable(),
    ),
    transition_delay_ms=3000,
...
FSM_vars.state_machine_nicholas_sandford.AddState(
    ...
    execute_fn=lambda: (
        Py4GW.Console.Log(
            "TH3KUM1KO -  TH3KUM1KO - GOING TO NICHOLAS SANDFORD", "USING FIRE STONE", Py4GW.Console.MessageType.Info
        ),
        useitem(30847),
    ),
    run_once=True,
...
class InventoryTracker:
    ...
    def get_farmed_items(self):
        ...
        try:
            ...
            Py4GW.Console.Log(
                "INVENTORY TRACKER", f"Error getting farmed items: {e}", Py4GW.Console.MessageType.Warning
            )
