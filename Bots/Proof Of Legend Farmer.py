...
plains2_movement_two = [(8847, -11686), (5011, -11487), (2946, -9737), (-105, -9656), (6936, -1245), (9241, -2488)]
...
plains2_movement_four = [(-7640, 7347), (-6484, 2170), (-421, 1978), (237, 2034)]
# endregion
...
def setup_first_chahbek_village(fsm, random_insert_chance=0.5):
    ...
    recruit_steps = [
        ...
        (
            "Type: delete charge",
            lambda: ActionQueueManager().AddAction("ACTION", Inventory.DestroyItem, Item.GetItemIdFromModelID(6060)),
            None,
            100,
            True,
            None,
        ...
        (
            "Move: Near Recruit",
            lambda: Routines.Movement.FollowPath(fsm_vars.first_chahbek_village_pathing, fsm_vars.movement_handler),
            lambda: Routines.Movement.IsFollowPathFinished(
                fsm_vars.first_chahbek_village_pathing, fsm_vars.movement_handler
            ),
            500,
            False,
            None,
        ...
        (
            "Target: Recruit #1",
            lambda: target_and_interact(4776, -6023)(),
            lambda: check_dialog_buttons(buttons=1),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: Quiz #1",
            lambda: click_dialog_button_retry(button=1),
            lambda: check_dialog_buttons(buttons=0),
            500,
            False,
            None,
            None,
        ...
        (
            "Target: Recruit #2",
            lambda: target_and_interact(5077, -7017)(),
            lambda: check_dialog_buttons(buttons=1),
            500,
            False,
            None,
        ...
        (
            "Target: Recruit #3",
            lambda: target_and_interact(3457, -6284)(),
            lambda: check_dialog_buttons(buttons=1),
            500,
            False,
            None,
        ...
        (
            "Click: Quiz #3",
            lambda: click_dialog_button_retry(button=1),
            lambda: check_dialog_buttons(buttons=0) or check_quest_completed(709),
            500,
            False,
            None,
            None,
    ...
    post_recruit_steps = [
        (
            "Target: Jahdugar #2",
            lambda: target_and_interact(3482, -5167)(),
            lambda: check_dialog_buttons(buttons=1) and has_arrived(),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: Accept #2",
            lambda: click_dialog_button_retry(button=1),
            lambda: check_dialog_buttons(buttons=2),
            500,
            False,
            None,
            lambda: Keystroke.PressAndRelease(Key.Escape.value),
...
fsm_vars.churrhir_fields.AddState(
    ...
    exit_condition=lambda: (is_npc_dialog_hidden() or check_active_quest(600)),
    transition_delay_ms=500,
    run_once=False,
...
fsm_vars.churrhir_fields.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.churrhir_near_dehvad, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.churrhir_fields.AddState(
...
fsm_vars.churrhir_fields.AddState(
    ...
    and Party.IsPartyLoaded()
    and bot_vars.has_post_mission_run,
    transition_delay_ms=2000,
    on_exit=lambda: reset_state_variables(),
)
# endregion
...
def build_kamadan_initial_fsm(fsm):
    ...
    early_steps = [
        ...
        (
            "Move: Near merchants",
            lambda: Routines.Movement.FollowPath(fsm_vars.kamadan_move_near_merchants, fsm_vars.movement_handler),
            lambda: Routines.Movement.IsFollowPathFinished(
            ...
            False,
            None,
            reset_paths_and_handler(fsm_vars.kamadan_move_near_merchants),
        ),
    ]
    ...
    mehinu_path = [
        (
            "Target: Mehinu",
            lambda: target_and_interact(-11202, 9346)(),
            lambda: check_dialog_buttons(buttons=2, state_key="small_mehinu"),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: Transport",
            lambda: click_dialog_button_retry(button=1),
            lambda: check_dialog_buttons(buttons=2, state_key="big_mehinu"),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: I'm not scared",
            lambda: click_dialog_button_retry(button=1, backup="0x825F01"),
            lambda: is_npc_dialog_hidden() or check_active_quest(607),
            500,
            False,
            None,
            None,
    ...
    kahlim_path = [
        (
            "Target: Kahlim",
            lambda: target_and_interact(-11442, 9092)(),
            lambda: check_dialog_buttons(buttons=2, state_key="small_kahlim"),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: Material Girl",
            lambda: click_dialog_button_retry(button=1),
            lambda: check_dialog_buttons(buttons=2, state_key="big_kahlim"),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: I'll find her",
            lambda: click_dialog_button_retry(button=1, backup="0x826101"),
            lambda: is_npc_dialog_hidden() or check_active_quest(609),
            500,
            False,
            None,
            None,
    ...
    chorben_path = [
        (
            "Target: Chorben",
            lambda: target_and_interact(-11270, 8785)(),
            lambda: check_dialog_buttons(buttons=2, state_key="small_chorben"),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: Quality Steel",
            lambda: click_dialog_button_retry(button=1),
            lambda: check_dialog_buttons(buttons=2, state_key="big_chorben"),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: No problem",
            lambda: click_dialog_button_retry(button=1, backup="0x826001"),
            lambda: is_npc_dialog_hidden() or check_active_quest(608),
            500,
            False,
            None,
            None,
    ...
    final_steps = [
        (
            "Move: Middle",
            lambda: Routines.Movement.FollowPath(fsm_vars.kamadan_middle, fsm_vars.movement_handler),
            lambda: Routines.Movement.IsFollowPathFinished(fsm_vars.kamadan_middle, fsm_vars.movement_handler),
            500,
            False,
            None,
            None,
        ...
        (
            "Target: Jueh",
            lambda: target_and_interact(-9297, 11887)(),
            lambda: check_dialog_buttons(buttons=2),
            500,
            False,
            None,
            reset_paths_and_handler(fsm_vars.kamadan_middle),
        ),
        (
            "Click: Sounds good.",
            lambda: click_dialog_button_retry(button=1, backup="0x82A101"),
            lambda: is_npc_dialog_hidden() or check_active_quest(673),
            500,
            False,
            None,
            None,
        ...
        (
            "Move: Storage",
            lambda: Routines.Movement.FollowPath(fsm_vars.kamadan_storage, fsm_vars.movement_handler),
            lambda: Routines.Movement.IsFollowPathFinished(fsm_vars.kamadan_storage, fsm_vars.movement_handler),
            500,
            False,
            None,
            None,
        ...
        (
            "Target: Xunlai Agent",
            lambda: target_and_interact(-7711, 14455)(),
            lambda: check_dialog_buttons(buttons=2),
            500,
            False,
            None,
        ...
        (
            "Click: Purchase",
            lambda: click_dialog_button_retry(button=1),
            lambda: check_dialog_buttons(buttons=3) or check_quest_completed(673),
            500,
            False,
            None,
            None,
        ...
        (
            "Move: Exit Kamadan",
            lambda: Routines.Movement.FollowPath(fsm_vars.kamadan_exit_pathing, fsm_vars.movement_handler),
            lambda: Routines.Movement.IsFollowPathFinished(fsm_vars.kamadan_exit_pathing, fsm_vars.movement_handler)
            or Map.IsMapLoading()
            or Map.GetMapID() == bot_vars.plains_of_jarin,
            500,
            False,
            None,
            reset_paths_and_handler(fsm_vars.kamadan_middle),
        ...
        (
            "Wait: Jarin",
            mark_flag("first_time_kamadan", True),
            lambda: Routines.Transition.IsExplorableLoaded(log_actions=False)
            and Party.IsPartyLoaded()
            and bot_vars.first_time_kamadan,
            2000,
            True,
            None,
            None,
...
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    exit_condition=lambda: (check_dialog_buttons(buttons=1) or check_dialog_buttons(buttons=2)),
    transition_delay_ms=500,
    run_once=False,
)
fsm_vars.plains_of_jarin_initial.AddState(
...
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains_move_to_dengo, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_initial.AddState(
...
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains_move_near_pelei, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_initial.AddState(
...
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    execute_fn=lambda: click_dialog_button_retry(button=1),
    exit_condition=lambda: (check_dialog_buttons(buttons=0) or is_npc_dialog_hidden()),
    transition_delay_ms=500,
    run_once=False,
    on_exit=lambda: Keystroke.PressAndRelease(Key.Escape.value),
)
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains_move_short_corsair, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains_move_near_nehdukah, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_initial.AddState(
...
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains_move_quest_mauban, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_initial.AddState(
...
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    exit_condition=lambda: (check_dialog_buttons(buttons=0) or check_active_quest(648)),
    transition_delay_ms=500,
    run_once=False,
)
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains_move_around, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains_move_quest_nehdukah, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_initial.AddState(
...
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    execute_fn=lambda: click_dialog_button_retry(button=1),
    exit_condition=lambda: (check_dialog_buttons(buttons=0) or check_active_quest(653)),
    transition_delay_ms=500,
    run_once=False,
)
fsm_vars.plains_of_jarin_initial.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(fsm_vars.plains_enter_ssgh, fsm_vars.movement_handler)
    or Map.IsMapLoading(),
    run_once=False,
    on_exit=lambda: [mark_flag("first_time_plains", True)(), mark_flag("summoned_imp", False)()],
)
fsm_vars.plains_of_jarin_initial.AddState(
    name="Wait: SSGH",
    ...
    exit_condition=lambda: Routines.Transition.IsOutpostLoaded(log_actions=False)
    and Party.IsPartyLoaded()
    and bot_vars.first_time_plains,
    transition_delay_ms=2000,
    on_exit=lambda: reset_state_variables(),
)
# endregion
...
fsm_vars.ssgh_initial.AddState(
    ...
    execute_fn=lambda: click_dialog_button_retry(button=1),
    exit_condition=lambda: (
        check_dialog_buttons(buttons=0) or check_dialog_buttons(buttons=1, state_key="seve") or is_npc_dialog_hidden()
    ),
    transition_delay_ms=2500,
    run_once=False,
)
fsm_vars.ssgh_initial.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(fsm_vars.ssgh_exit, fsm_vars.movement_handler)
    or Map.IsMapLoading(),
    run_once=False,
)
fsm_vars.ssgh_initial.AddState(
...
fsm_vars.plains_of_jarin_second.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains2_move_near_buff, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_second.AddState(
...
fsm_vars.plains_of_jarin_second.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains2_move_near_nehdukah, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_second.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains2_movement_one, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_second.AddState(
...
fsm_vars.plains_of_jarin_second.AddState(
    ...
    execute_fn=lambda: click_dialog_button_retry(button=1),
    exit_condition=lambda: (is_npc_dialog_hidden() or check_dialog_buttons(buttons=0)),
    transition_delay_ms=500,
    run_once=False,
)
fsm_vars.plains_of_jarin_second.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains2_movement_two, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_second.AddState(
...
fsm_vars.plains_of_jarin_second.AddState(
    name="Click: Material",
    execute_fn=lambda: click_dialog_button_retry(button=1),
    exit_condition=lambda: (check_dialog_buttons(buttons=0) or check_quest_completed(609)),
    transition_delay_ms=500,
    run_once=False,
)
fsm_vars.plains_of_jarin_second.AddState(
    ...
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        fsm_vars.plains2_movement_three, fsm_vars.movement_handler
    ),
    run_once=False,
)
fsm_vars.plains_of_jarin_second.AddState(
    ...
    exit_condition=lambda: Routines.Transition.HasArrivedToOutpost(
        outpost_id=bot_vars.sunspear_great_hall, log_actions=False
    ),
    transition_delay_ms=2000,
    on_exit=mark_flag("pause_combat_fsm", True),
)
...
fsm_vars.plains_of_jarin_second.AddState(
    name="Click: Accept",
    execute_fn=lambda: click_dialog_button_retry(button=1),
    exit_condition=lambda: (is_npc_dialog_hidden() or not check_quest_completed(653)),
...
fsm_vars.plains_of_jarin_second.AddState(
    ...
    exit_condition=lambda: Routines.Transition.IsOutpostLoaded(log_actions=False)
    and Party.IsPartyLoaded()
    and bot_vars.second_time_plains,
    transition_delay_ms=2000,
    on_exit=lambda: reset_state_variables(),
)
# endregion
...
def build_kamadan_second_fsm(fsm):
    ...
    early_steps = [
        ...
        (
            "Click: Accept #1",
            lambda: click_dialog_button_retry(button=1, backup="0x82A107"),
            lambda: is_npc_dialog_hidden(),
            500,
            False,
            None,
    ...
    mehinu_2_path = [
        (
            "Target: Mehinu",
            lambda: target_and_interact(-11202, 9346)(),
            lambda: check_dialog_buttons(buttons=1, state_key="Mehinu")
            or is_level(5)
            or not check_quest_completed(607),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: Accept #2",
            lambda: click_dialog_button_retry(button=1, backup="0x825F07"),
            lambda: is_npc_dialog_hidden() or is_level(5) or not check_quest_completed(607),
            500,
            False,
            None,
            None,
    ...
    kahlim_2_path = [
        (
            "Target: Kahlim",
            lambda: (None if is_level(5) else target_and_interact(-11442, 9092)()),
            lambda: check_dialog_buttons(buttons=1, state_key="Kahlim") or is_level(5),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: Accept #3",
            lambda: (None if is_level(5) else click_dialog_button_retry(button=1, backup="0x826107")),
            lambda: is_npc_dialog_hidden() or is_level(5),
            500,
            False,
            None,
            None,
    ...
    chorben_2_path = [
        (
            "Target: Chorben",
            lambda: (None if is_level(5) else target_and_interact(-11270, 8785)()),
            lambda: check_dialog_buttons(buttons=1, state_key="Chorben") or is_level(5),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: Accept #4",
            lambda: (None if is_level(5) else click_dialog_button_retry(button=1, backup="0x826007")),
            lambda: is_npc_dialog_hidden() or is_level(5),
            500,
            False,
            None,
    ...
    final_steps = [
        (
            "Target: Alekaya #1",
            lambda: (None if is_level(5) else target_and_interact(-10068, 8543)()),
            lambda: check_dialog_buttons(buttons=1) or is_level(5),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: Map Travel",
            lambda: (None if is_level(5) else click_dialog_button_retry(button=1)),
            lambda: check_dialog_buttons(buttons=0) or is_level(5),
            500,
            False,
            None,
            None,
        ...
        (
            "Click: Accept #5",
            lambda: (None if is_level(5) else click_dialog_button_retry(button=1, backup="0x828807")),
            lambda: is_npc_dialog_hidden() or is_level(5),
            500,
            False,
            None,
        ...
        (
            "Move: To Village",
            lambda: Routines.Transition.TravelToOutpost(outpost_id=bot_vars.chahbek_mission, log_actions=False),
            lambda: Routines.Transition.HasArrivedToOutpost(outpost_id=bot_vars.chahbek_mission, log_actions=False),
            500,
            False,
            None,
            lambda: mark_flag("pause_combat_fsm", True)(),
        ),
        (
            "Wait: Village",
            lambda: mark_flag("second_time_kamadan", True)(),
            lambda: Routines.Transition.IsOutpostLoaded(log_actions=False)
            and Party.IsPartyLoaded()
            and bot_vars.second_time_kamadan,
            2000,
            True,
            None,
            lambda: reset_state_variables(),
...
fsm_vars.finish_level_5.AddState(
    ...
    execute_fn=lambda: Routines.Movement.FollowPath(fsm_vars.ssgh_exit, fsm_vars.movement_handler),
    exit_condition=lambda: (
        Routines.Movement.IsFollowPathFinished(fsm_vars.ssgh_exit, fsm_vars.movement_handler) or Map.IsMapLoading()
    ),
    run_once=False,
)
fsm_vars.finish_level_5.AddState(
...
fsm_vars.finish_level_5.AddState(
    ...
    execute_fn=lambda: Routines.Movement.FollowPath(fsm_vars.plains2_move_near_nehdukah, fsm_vars.movement_handler),
    exit_condition=lambda: (
        Routines.Movement.IsFollowPathFinished(fsm_vars.plains2_move_near_nehdukah, fsm_vars.movement_handler)
        or is_level(5)
    ),
    run_once=False,
)
fsm_vars.finish_level_5.AddState(
    ...
    execute_fn=lambda: Routines.Movement.FollowPath(fsm_vars.plains2_movement_one, fsm_vars.movement_handler),
    exit_condition=lambda: (
        Routines.Movement.IsFollowPathFinished(fsm_vars.plains2_movement_one, fsm_vars.movement_handler) or is_level(5)
    ),
    run_once=False,
)
fsm_vars.finish_level_5.AddState(
    ...
    exit_condition=lambda: (check_dialog_buttons(buttons=2) or is_level(5)),
    transition_delay_ms=500,
    run_once=False,
)
fsm_vars.finish_level_5.AddState(
    ...
    exit_condition=lambda: (is_npc_dialog_hidden() or check_dialog_buttons(buttons=0) or is_level(5)),
    transition_delay_ms=500,
    run_once=False,
)
fsm_vars.finish_level_5.AddState(
    name="Move: Clear to Pelei",
    execute_fn=lambda: (
        None if is_level(5) else Routines.Movement.FollowPath(fsm_vars.plains2_movement_two, fsm_vars.movement_handler)
    ),
    exit_condition=lambda: (
        Routines.Movement.IsFollowPathFinished(fsm_vars.plains2_movement_two, fsm_vars.movement_handler) or is_level(5)
    ),
    run_once=False,
)
fsm_vars.finish_level_5.AddState(
    ...
    execute_fn=lambda: (
        None
        if is_level(5)
        else Routines.Movement.FollowPath(fsm_vars.plains2_movement_three, fsm_vars.movement_handler)
    ),
    exit_condition=lambda: (
        Routines.Movement.IsFollowPathFinished(fsm_vars.plains2_movement_three, fsm_vars.movement_handler)
        or is_level(5)
    ),
    run_once=False,
)
fsm_vars.finish_level_5.AddState(
    ...
    exit_condition=lambda: Routines.Transition.HasArrivedToOutpost(
        outpost_id=bot_vars.chahbek_mission, log_actions=False
    ),
    transition_delay_ms=500,
    on_exit=mark_flag("pause_combat_fsm", False),
)
...
fsm_vars.second_chahbek_village.AddState(
    name="Load: skill bar", execute_fn=lambda: load_skill_bar(), transition_delay_ms=1000
)
fsm_vars.second_chahbek_village.AddState(
    name="Target: Jahdugar",
...
fsm_vars.second_chahbek_village.AddState(
    ...
    exit_condition=lambda: Routines.Transition.IsExplorableLoaded(log_actions=False)
    and Party.IsPartyLoaded()
    and bot_vars.second_time_chahbek_village,
    transition_delay_ms=2000,
)
# endregion
...
fsm_vars.finish_up_deposit.AddState(
    ...
    exit_condition=lambda: Item.GetItemIdFromModelID(bot_vars.proof_of_legend) == 0
...
fsm_vars.create_character.AddState(
    ...
    execute_fn=lambda: bot_vars.press_key_aq.add_action(Keystroke.PressAndRelease, Key.Enter.value),
    exit_condition=lambda: (
        Map.GetMapID() == bot_vars.island_of_shehkah and Party.IsPartyLoaded() and Map.IsMapReady()
...
fsm_vars.state_machine.AddSubroutine(
    ...
    condition_fn=lambda: (
        Map.GetMapID() == bot_vars.churrhir_fields and Map.IsExplorable() and not bot_vars.has_post_mission_run
    ),
)
fsm_vars.state_machine.AddSubroutine(
    ...
    condition_fn=lambda: (
        Map.GetMapID() == bot_vars.kamadan
        and Map.IsOutpost()
        and bot_vars.has_post_mission_run
        and not bot_vars.first_time_kamadan
    ),
)
fsm_vars.state_machine.AddSubroutine(
    ...
    condition_fn=lambda: (
        Map.GetMapID() == bot_vars.plains_of_jarin
        and Map.IsExplorable()
        and bot_vars.first_time_kamadan
        and not bot_vars.first_time_plains
    ),
)
fsm_vars.state_machine.AddSubroutine(
    ...
    condition_fn=lambda: (
        Map.GetMapID() == bot_vars.sunspear_great_hall
        and Map.IsOutpost()
        and bot_vars.first_time_plains
        and not bot_vars.first_time_ssgh
    ),
)
fsm_vars.state_machine.AddSubroutine(
    ...
    condition_fn=lambda: (
        ...
        and Map.IsExplorable()
        and bot_vars.first_time_ssgh
        and not bot_vars.second_time_plains
    ),
)
fsm_vars.state_machine.AddSubroutine(
    ...
    condition_fn=lambda: (
        ...
        and Map.IsOutpost()
        and bot_vars.second_time_plains
        and not bot_vars.second_time_kamadan
    ),
)
fsm_vars.state_machine.AddSubroutine(
    name="Ex: Farm a bit",
...
fsm_vars.state_machine.AddSubroutine(
    ...
    condition_fn=lambda: (
        ...
        and Map.IsOutpost()
        and bot_vars.second_time_kamadan
        and not bot_vars.second_time_chahbek_village
        and is_level(5)
    ),
)
fsm_vars.state_machine.AddSubroutine(
    ...
    sub_fsm=fsm_vars.chahbek_mission,
    condition_fn=lambda: (
        Map.GetMapID() == bot_vars.chahbek_mission
        and Map.IsExplorable()
        and bot_vars.second_time_chahbek_village
        and not bot_vars.second_mission_run
        and is_level(5)
    ),
)
fsm_vars.state_machine.AddSubroutine(
